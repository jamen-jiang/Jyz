...
namespace Jyz.Infrastructure.Data.Extensions
{
    public static class ModuleExtension
    {
        ...
        /// <returns></returns>
        public static IQueryable<Module> WhereByModuleIds(this IQueryable<Module> query, params Guid [] moduleIds)
        {
            if(moduleIds !=null)
            {
        ...
        /// <param name="id"></param>
        /// <returns></returns>
        public static bool IsExist(this IQueryable<Module> query, string moduleName, Guid id)
        {
